  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Découvrez les résolutions les plus utiles et plébiscitées par la communauté SolvHub[cite: 33]." />
      </Helmet>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 text-sm mt-1">
              Les résolutions les plus utiles et plébiscitées par la communauté[cite: 33].
            </p>
          </div>
          <button
          ...
          >
            ← Retour aux classements[cite: 33]
          </button>
        </div>

        {loading ? (
          <p className="text-center text-slate-500 py-12">Chargement du classement...[cite: 33]</p>
        ) : solutions.length === 0 ? (
          <p className="text-center text-slate-500 py-12">Aucune solution classée pour le moment[cite: 33].</p>
        ) : (
                ...
                {top3[1] && (() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-400">Par {top3[1].user?.username || "Anonyme"}[cite: 33]</p>
                      {scorePercentage !== null && (
                        <div>
                          <span className="text-[10px] text-emerald-400 font-semibold bg-emerald-950/50 border border-emerald-800/50 px-2 py-0.5 rounded-full">
                            {scorePercentage}% de réussite[cite: 33]
                          </span>
                        </div>
                      )}
                    </div>
                ...
                {top3[0] && (() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-amber-400 font-medium">Par {top3[0].user?.username || "Anonyme"}[cite: 33]</p>
                      {scorePercentage !== null && (
                        <div>
                          <span className="text-[10px] text-emerald-400 font-semibold bg-emerald-950/50 border border-emerald-800/50 px-2 py-0.5 rounded-full">
                            {scorePercentage}% de réussite[cite: 33]
                ...
                {top3[2] && (() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-400">Par {top3[2].user?.username || "Anonyme"}[cite: 33]</p>
                      {scorePercentage !== null && (
                        <div>
                          <span className="text-[10px] text-emerald-400 font-semibold bg-emerald-950/50 border border-emerald-800/50 px-2 py-0.5 rounded-full">
                            {scorePercentage}% de réussite[cite: 33]
                      ...
                      >
                        <div className="flex items-center gap-4 overflow-hidden">
                          ...
                          <div className="overflow-hidden">
                            ...
                            <p className="text-xs text-slate-400 mt-0.5">Par {sol.user?.username || "Anonyme"}[cite: 33]</p>
                          </div>
                        </div>
