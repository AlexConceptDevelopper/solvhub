...
export default function CGU() {
  return (
    <>
      <Helmet>
        <title>Conditions Générales d'Utilisation (CGU) | SolvHub</title>
        <meta name="description" content="Consultez les Conditions Générales d'Utilisation de la plateforme SolvHub." />
      </Helmet>
