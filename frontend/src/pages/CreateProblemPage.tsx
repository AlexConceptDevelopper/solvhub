...
export default function CreateProblemPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Partager un problème ou une panne | SolvHub</title>
        <meta name="description" content="Partagez un problème technique ou une panne sur SolvHub pour obtenir de l'aide de la communauté." />
      </Helmet>
