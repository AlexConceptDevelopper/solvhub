...
export default function ProfilePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Mon Profil & Mes Contributions | SolvHub</title>
        <meta name="description" content="Gérez vos informations personnelles, vos paramètres de sécurité et retrouvez tous vos problèmes et solutions publiés sur SolvHub." />
      </Helmet>
