...
export default function CategoryProblemsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>{category ? `${category.name} - Problèmes | SolvHub` : "Catégorie - Problèmes | SolvHub"}</title>
        <meta name="description" content={category ? `Découvrez tous les problèmes et pannes de la catégorie ${category.name} sur SolvHub.` : "Découvrez les problèmes par catégorie sur SolvHub."} />
      </Helmet>
