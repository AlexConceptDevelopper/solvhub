...
export default function RankingHubPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Classements et Tops | SolvHub</title>
        <meta name="description" content="Découvrez les tops contributeurs, les solutions les plus utiles et les problèmes populaires de la communauté SolvHub." />
      </Helmet>
