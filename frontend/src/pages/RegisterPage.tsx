...
export default function RegisterPage() {
  ...
  if (data) {
    return (
      <>
        <Helmet>
          <title>Vérifiez votre boîte mail | SolvHub</title>
          <meta name="description" content="Validez votre inscription pour rejoindre la communauté SolvHub[cite: 34]." />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>Inscription | SolvHub</title>
        <meta name="description" content="Créez un compte pour rejoindre la communauté SolvHub et partager vos solutions[cite: 34]." />
      </Helmet>
      ...
      <div className="relative min-h-[80vh] flex flex-col items-center justify-center px-4 overflow-hidden py-8">
        ...
        <div className="relative w-full max-w-md bg-white border border-slate-200 p-8 rounded-2xl shadow-sm">
          ...
          <p className="text-slate-500 text-sm text-center mb-6">Rejoignez la communauté SolvHub[cite: 34]</p>
